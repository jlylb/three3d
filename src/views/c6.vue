...
import SceneUtils from'@/components/su.js';
...
methods: {
    init() {
        ...
        this.$refs.cn.appendChild(webGLRenderer.domElement);
...
gui.add(controls, 'positionX', -100, 100).onChange(controls.reCamera);
gui.add(controls, 'positionY', -100, 100).onChange(controls.reCamera);
gui.add(controls, 'positionZ', -100, 100).onChange(controls.reCamera);
