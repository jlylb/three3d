...
ParticleEngine.prototype.initialize = function() {
  ...
  for (var i = 0; i < this.particleCount; i++) {
    ...
    this.particleMaterial.attributes.customVisible.value[
      i
    ] = this.particleArray[i].alive
    this.particleMaterial.attributes.customColor.value[i] = this.particleArray[
      i
    ].color
    this.particleMaterial.attributes.customOpacity.value[
      i
    ] = this.particleArray[i].opacity
    this.particleMaterial.attributes.customSize.value[i] = this.particleArray[
      i
    ].size
    this.particleMaterial.attributes.customAngle.value[i] = this.particleArray[
      i
    ].angle
  }
...
ParticleEngine.prototype.update = function(dt) {
  ...
  for (var i = 0; i < this.particleCount; i++) {
    if (this.particleArray[i].alive) {
      ...
      this.particleMaterial.attributes.customColor.value[
        i
      ] = this.particleArray[i].color
      this.particleMaterial.attributes.customOpacity.value[
        i
      ] = this.particleArray[i].opacity
      this.particleMaterial.attributes.customSize.value[i] = this.particleArray[
      ...
      this.particleMaterial.attributes.customAngle.value[
        i
      ] = this.particleArray[i].angle
    }
  }
