...
import ParticleEngine from './patricle.js';

var starPng = require('../assets/patricle/star.png')
var smokePng = require('../assets/patricle/smokeparticle.png')
var snowPng = require('../assets/patricle/snowflake.png')
var raindrop2flipPng = require('../assets/patricle/raindrop2flip.png')

var sparkPng = require('../assets/patricle/spark.png')
var spikeyPng = require('../assets/patricle/spikey.png')
...
export const Examples =
{
	...
	fountain :
	{
		...
		particleTexture : new THREE.TextureLoader().load( starPng ),
		...
		sizeTween    : new ParticleEngine.Tween( [0, 1], [1, 20] ),
		opacityTween : new ParticleEngine.Tween( [2, 3], [1, 0] ),
		colorTween   : new ParticleEngine.Tween( [0.5, 2], [ new THREE.Vector3(0,1,0.5), new THREE.Vector3(0.8, 1, 0.5) ] ),
	...
	fireball :
	{
		...
		velocityStyle : ParticleEngine.Type.SPHERE,
		speedBase     : 40,
		speedSpread   : 8,
		
		particleTexture :new  THREE.TextureLoader().load(smokePng ),

		sizeTween    : new ParticleEngine.Tween( [0, 0.1], [1, 150] ),
		opacityTween : new ParticleEngine.Tween( [0.7, 1], [1, 0] ),
	...
	smoke :
	{
		...
		sizeTween    : new ParticleEngine.Tween( [0, 1], [32, 128] ),
		opacityTween : new ParticleEngine.Tween( [0.8, 2], [0.5, 0] ),
		colorTween   : new ParticleEngine.Tween( [0.4, 1], [ new THREE.Vector3(0,0,0.2), new THREE.Vector3(0, 0, 0.5) ] ),
	...
	clouds :
	{
		...
		opacityTween : new ParticleEngine.Tween([0,1,4,5],[0,1,1,0]),
	...
	snow :
	{
		...
		particleTexture : new THREE.TextureLoader().load(snowPng),
			
		sizeTween    : new ParticleEngine.Tween( [0, 0.25], [1, 10] ),
		colorBase   : new THREE.Vector3(0.66, 1.0, 0.9), // H,S,L
		opacityTween : new ParticleEngine.Tween( [2, 3], [0.8, 0] ),
	...
	rain :
	{
		...
		particleTexture :new  THREE.TextureLoader().load(raindrop2flipPng),
	...
	starfield :
	{
		...
		particleTexture : new THREE.TextureLoader().load( spikeyPng),
	...
	fireflies :
	{
		...
		particleTexture : new THREE.TextureLoader().load( sparkPng),

		sizeBase   : 30.0,
		sizeSpread : 2.0,
		opacityTween : new ParticleEngine.Tween([0.0, 1.0, 1.1, 2.0, 2.1, 3.0, 3.1, 4.0, 4.1, 5.0, 5.1, 6.0, 6.1],
	...
	firework :
	{
		...
		sizeTween    : new ParticleEngine.Tween( [0.5, 0.7, 1.3], [5, 40, 1] ),
		opacityTween : new ParticleEngine.Tween( [0.2, 0.7, 2.5], [0.75, 1, 0] ),
		colorTween   : new ParticleEngine.Tween( [0.4, 0.8, 1.0], [ new THREE.Vector3(0,1,1), new THREE.Vector3(0,1,0.6), new THREE.Vector3(0.8, 1, 0.6) ] ),
		blendStyle   : THREE.AdditiveBlending,  
    ...
    candle :
	{
		...
		sizeTween    : new ParticleEngine.Tween( [0, 0.3, 1.2], [20, 150, 1] ),
		opacityTween : new ParticleEngine.Tween( [0.9, 1.5], [1, 0] ),
		colorTween   : new ParticleEngine.Tween( [0.5, 1.0], [ new THREE.Vector3(0.02, 1, 0.5), new THREE.Vector3(0.05, 1, 0) ] ),
		blendStyle : THREE.AdditiveBlending,  
